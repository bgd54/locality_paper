...
\caption{Airfoil's \texttt{res\_calc} bandwidth on a dataset with $2880000$ 
cells with hierarchical coloring, on Volta architecture. Note that the 
...
$4000000$ edges using hierarchical coloring. Note that the y-axis does not 
...
with $4913000$ cells using hierarchical coloring. Note that the y-axis 
