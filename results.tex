...
\begin{table}[Htbp]
  ...
  \begin{tabular}{|r|cc|c|c|}
    \hline
      ...
      \hline
        ...
        Global Memory Read Transactions (total) &   $33572\text{k}$ &   $35408\text{k}$ &   $22888\text{k}$ &   $25027\text{k}$\\
       Global Memory Write Transactions (total) &   $12673\text{k}$ &   $12704\text{k}$ &   $ 8047\text{k}$ &   $ 8701\text{k}$\\
  ...
  \caption{Collected performance metrics of the hierarchical colouring
  implementation of the \textbf{IntegrateStressForElems} kernel.}
